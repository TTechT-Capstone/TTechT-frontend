...
export default function AdminProducts() {
  ...
  return !isMobile ? (
    <main className="font-inter p-4 min-h-screen">
      ...
      {/* Table Header */}
      <div className="text-sm grid grid-cols-6 justify-items-center font-inter font-bold bg-gray-100 px-4 py-3 rounded-t-lg">
        <div>Product</div>
        <div>Quantity</div>
    ...
    <main className="font-inter p-4 min-h-screen">
      ...
      {/* Table Header */}
      <div className="text-xs grid grid-cols-4 justify-items-center font-urbanist font-bold bg-gray-100 px-4 py-3 rounded-t-lg">
        <div>Product</div>
        <div>Quantity</div>
        <div>Price</div>
        <div>Action</div>
