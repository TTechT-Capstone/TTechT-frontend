...
import { getSellerById } from "@/app/apis/auth.api";
...
export default function SellerWatermarkImageGenerator() {
  ...
  <section className="font-roboto p-6 max-w-5xl mx-auto rounded-xl">
    <h1 className="font-urbanist text-3xl font-bold text-primary mb-1">Watermarking Image</h1>
    <p className="text-gray-600 text-sm mb-8">
      This image will be used as your watermark to protect your products from unauthorized reuse.
    </p>

    <div className="bg-[#FAFAFA] border border-gray-200 rounded-xl p-6 space-y-6">
      <div className="text-gray-700 text-center">Watermarking Image Preview:</div>
      ...
      {selectedImage && (
        <div className="text-green-700 bg-green-100 border border-green-300 px-4 py-3 rounded text-center font-medium">
          ✅ Watermark image selected and ready to embed!
        </div>
      )}
    </div>
  </section>
