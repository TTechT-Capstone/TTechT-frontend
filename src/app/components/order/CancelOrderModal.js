export default function CancelOrderModal({
  ...
  return (
    <>
      <div className="font-inter fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
        <div className="bg-white p-6 rounded-lg shadow-lg">
          <h2 className="font-playfair text-lg font-semibold mb-4">Cancel Order</h2>
