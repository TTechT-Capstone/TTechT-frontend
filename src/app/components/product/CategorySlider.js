      ...
      {showButtons && (
        <>
          <button
            ...
            className="absolute left-2 top-1/2 -translate-y-1/2 bg-gray-200 p-2 rounded-full shadow hover:bg-gray-300 z-10 opacity-50 hover:opacity-100 transition-opacity duration-300 hidden sm:block"
          ...
          <button
            onClick={() => scrollBy(200)}
            className="absolute right-2 top-1/2 -translate-y-1/2 bg-gray-200 p-2 rounded-full shadow hover:bg-gray-300 z-10 opacity-50 hover:opacity-100 transition-opacity duration-300 hidden sm:block"
