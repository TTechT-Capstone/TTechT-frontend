    ...
    <>
      ...
      >
        ...
        <div className="flex flex-col space-y-2 sm:space-y-3">
          <h1 className="text-md sm:text-2xl font-semibold">Success Embedded Watermark</h1>
          <p className="text-sm sm:text-md whitespace-pre-line">Success protect your product with hidden watermark</p>
        </div>
      </div>
    </>
  );
