...
export default function ProfileForm({
  ...
  return (
    <>
      <div className="w-full font-inter bg-white shadow-xl p-6 space-y-6 rounded-lg mx-auto">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <input
                type="text"
                id="userName"
                className="w-full px-4 py-3 bg-gray-200 border border-gray-300 rounded-lg text-gray-800 focus:outline-none focus:ring-2 transition cursor-not-allowed"
